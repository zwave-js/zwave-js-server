...
Files are located in `src/lib/<object>/` directories.

#### New Commands

| Object     | Command                                         | Files                                               |
| ---------- | ----------------------------------------------- | --------------------------------------------------- |
| Controller | `controller.get_all_association_groups`         | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_all_associations`               | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_background_rssi`                | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_all_available_firmware_updates` | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_dsk`                            | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_long_range_nodes`               | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.begin_joining_network`              | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.stop_joining_network`               | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.begin_leaving_network`              | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.stop_leaving_network`               | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_nvm_id`                         | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.external_nvm_*`                     | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_supported_rf_regions`           | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.query_supported_rf_regions`         | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.query_rf_region_info`               | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.assign_*_routes`                    | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.delete_*_routes`                    | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.get_*_cached`                       | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.*_priority_route`                   | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.discover_node_neighbors`            | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.start_watchdog`                     | command.ts, message_handler.ts, outgoing_message.ts |
| Controller | `controller.stop_watchdog`                      | command.ts, message_handler.ts, outgoing_message.ts |
| Driver     | `driver.soft_reset_and_restart`                 | command.ts, message_handler.ts                      |
| Driver     | `driver.enter_bootloader`                       | command.ts, message_handler.ts                      |
| Driver     | `driver.leave_bootloader`                       | command.ts, message_handler.ts                      |
| Driver     | `driver.get_supported_cc_version`               | command.ts, message_handler.ts                      |
| Driver     | `driver.get_safe_cc_version`                    | command.ts, message_handler.ts                      |
| Driver     | `driver.update_user_agent`                      | command.ts, message_handler.ts                      |
| Endpoint   | `endpoint.get_ccs`                              | command.ts, message_handler.ts                      |
| Endpoint   | `endpoint.may_support_basic_cc`                 | command.ts, message_handler.ts                      |
| Endpoint   | `endpoint.was_cc_removed_via_config`            | command.ts, message_handler.ts                      |
| Node       | `node.check_link_reliability`                   | command.ts, message_handler.ts                      |
| Node       | `node.is_link_reliability_check_in_progress`    | command.ts, message_handler.ts                      |
| Node       | `node.abort_link_reliability_check`             | command.ts, message_handler.ts                      |
| Zniffer    | `zniffer.get_lr_regions`                        | command.ts, message_handler.ts                      |
| Zniffer    | `zniffer.get_current_lr_channel_config`         | command.ts, message_handler.ts                      |
| Zniffer    | `zniffer.get_supported_lr_channel_configs`      | command.ts, message_handler.ts                      |
| Zniffer    | `zniffer.set_lr_channel_config`                 | command.ts, message_handler.ts                      |

#### New Events

| Object     | Event                    | Files              |
| ---------- | ------------------------ | ------------------ |
| Controller | `network found`          | message_handler.ts |
| Controller | `network joined`         | message_handler.ts |
| Controller | `network left`           | message_handler.ts |
| Controller | `joining network failed` | message_handler.ts |
| Controller | `leaving network failed` | message_handler.ts |
| Driver     | `all nodes ready`        | message_handler.ts |
| Driver     | `error`                  | message_handler.ts |
| Driver     | `bootloader ready`       | message_handler.ts |

#### New State Properties

| Object     | Property                 | Files    |
| ---------- | ------------------------ | -------- |
| Controller | `isSIS`                  | state.ts |
| Controller | `maxPayloadSize`         | state.ts |
| Controller | `maxPayloadSizeLR`       | state.ts |
| Controller | `zwaveApiVersion`        | state.ts |
| Controller | `zwaveChipType`          | state.ts |
| Driver     | `ready`                  | state.ts |
| Driver     | `allNodesReady`          | state.ts |
| Driver     | `configVersion`          | state.ts |
| Node       | `canSleep`               | state.ts |
| Node       | `supportsWakeUpOnDemand` | state.ts |
| Node       | `hardwareVersion`        | state.ts |
| Node       | `hasSUCReturnRoute`      | state.ts |
| Node       | `manufacturer`           | state.ts |
| Node       | `dsk`                    | state.ts |
