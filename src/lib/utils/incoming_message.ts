...
export interface IncomingCommandUtilsGetEnumMemberName extends IncomingCommandUtilsBase {
  command: UtilsCommand.getEnumMemberName;
  enumeration: unknown;
  value: number;
}

export interface IncomingCommandUtilsRssiToString extends IncomingCommandUtilsBase {
